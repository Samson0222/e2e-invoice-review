      ...
      <div className="mb-6">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-600">
            Check the preview first. The file is only sent to the pipeline after you confirm.
          </p>
        </div>
      </div>
          ...
          <Card className="h-fit">
            ...
            <CardContent>
              ...
              <p className="mt-5 border-t border-zinc-100 pt-5 text-sm leading-6 text-zinc-500">
                The app classifies the document, extracts fields, validates VAT and totals, then
